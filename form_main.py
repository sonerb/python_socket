...
class Ui_SocketChat(object):
    def setupUi(self, SocketChat):
        ...
        self.actionPrerefences = QtWidgets.QAction(SocketChat)
        self.actionPrerefences.setObjectName("actionPrerefences")
        self.menuFile.addAction(self.actionConnect)
        self.menuFile.addAction(self.actionDisconnect)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionClose)
        self.menuSettings.addAction(self.actionPrerefences)
    ...
    def retranslateUi(self, SocketChat):
        ...
        self.actionPrerefences.setText(_translate("SocketChat", "Preferences"))
